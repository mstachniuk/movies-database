...
/**
 * ProdcompaniesId generated by hbm2java
 */
@Embeddable
public class ProdcompaniesId implements java.io.Serializable {

    private int movieid;
    private String name;
    private String addition;

    public ProdcompaniesId() {
    }

    public ProdcompaniesId(int movieid, String name) {
        this.movieid = movieid;
        this.name = name;
    }

    public ProdcompaniesId(int movieid, String name, String addition) {
        this.movieid = movieid;
        this.name = name;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof ProdcompaniesId))
            return false;
        ProdcompaniesId castOther = (ProdcompaniesId) other;
