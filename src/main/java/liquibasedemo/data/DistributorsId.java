...
/**
 * DistributorsId generated by hbm2java
 */
@Embeddable
public class DistributorsId implements java.io.Serializable {

    private int movieid;
    private String name;
    private String addition;

    public DistributorsId() {
    }

    public DistributorsId(int movieid, String name) {
        this.movieid = movieid;
        this.name = name;
    }

    public DistributorsId(int movieid, String name, String addition) {
        this.movieid = movieid;
        this.name = name;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof DistributorsId))
            return false;
        DistributorsId castOther = (DistributorsId) other;
